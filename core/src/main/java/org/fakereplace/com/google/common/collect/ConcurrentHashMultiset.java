...
import static org.fakereplace.com.google.common.collect.Multisets.checkNonnegative;
import org.fakereplace.com.google.common.collect.Serialization.FieldSetter;
import org.fakereplace.com.google.common.annotations.VisibleForTesting;
  ...
  @Override public int add(E element, int occurrences) {
    ...
    while (true) {
      ...
      if (current == 0) {
        ...
        Preconditions.checkArgument(occurrences <= Integer.MAX_VALUE - current,
