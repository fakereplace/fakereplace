 ...
 */
public class ChangedField implements AnnotationTarget {
    ...
    public ChangedField(Type genericType, int modifiers, Class<?> fieldType, String name, Set<ChangedAnnotation> annotations) {
